...
          @endif --}}
            ...
            <form action='' method='post'>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name='content' id="content" value="{{isset($data['content'])?$data['content']:old('content')}}">
                    </div>
                </div>
                <div class="mb-3 row">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item['content']}}</td>
                        <td>
                            <a href="{{ url('posts/'. $item['id']) }}" class="btn btn-warning btn-sm">Edit</a>
                            <form action="{{url('posts/'.$item['id'])}}" method="post" onsubmit="return confirm 
